...
public final class UpdateStudent_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("</head>\n");
      out.write("<body>\n");
      out.write("    <center><h1>Question list</h1></center>\n");
      ...
      out.write("        <tr bgcolor=\"cyan\"><th>email</th><th>sname</th><th>squa</th><th>sdob</th><th>sgender</th><th>saddr</th><th>scity/th><th>state</th><th>pin</th><th>scont</th><th>Action 1</th><th>Action 2</th></tr>\n");
      out.write("        ");
          ...
          while(db.rst.next()){
              out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td>");
               out.println("<td>"+db.rst.getString(4)+"</td><td>"+db.rst.getString(5)+"</td>");
                out.println("<td>"+db.rst.getString(6)+"</td><td>"+db.rst.getString(7)+"</td><td>"+db.rst.getString(8)+"</td><td>"+db.rst.getString(9)+"</td><td>"+db.rst.getString(10)+"</td><td> <a href='StudentUpdate.jsp?email="+db.rst.getString(1)+"'>Update</a></td><td> <a href='QuestionDelete?qid="+db.rst.getString(1)+"'>Delete</a></td></tr>");
          }
        }
        catch(Exception e){
            e.printStackTrace();
